...
export const Experiences = () => {
	const { selected: { experiences }, queries: { tags } } = useResumeBuilder();
	...
	return (
		<Box className="space-y-1.5 cursor-pointer ring-1 ring-transparent ring-offset-8 hover:ring-primary">
